...
public class TwoWayDataRecordListMain {
    public static void main(String[] args) {
        ...
        log("List from beginning: ");
        twoWayList.print();

        log("Deleting record Kowalski...");
        twoWayList.remove("Kowalski");
        log("Deleted");

        log("Deleting record Malinowski...");
        twoWayList.remove("Malinowski");
        log("Deleted");

        System.out.printf("Size = %d\n", twoWayList.size());

        log("List from end: ");
        twoWayList.printFromEnd();
    }
}
